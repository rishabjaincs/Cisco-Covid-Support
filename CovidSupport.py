        ...
        "body": [
            ...
            },
            {
                ...
                "actions": [
                    ...
                    #     }
                    # }
                    # Commented out the above json since for Tamil Nadu we have seen way too long json error and to suppress it removing help link as we have already provided that in welcome card
                ],
                "horizontalAlignment": "Center"
            }
        ]
...
def startToken(roomId,parentId,token,state):
    print("Initializing Detail Card for more info !!!")
    print(state)
    ...
    card={
     "roomId": roomId,
      "markdown": "Initiating Covid Support Form to search or insert details !!",
      "attachments": [
        {
